...
export const SOLUTIONS_LIST: SolutionItem[] = [
  {
    ...
    specs: ["TEMA Types: BEM, BEU, AES, AKT", "Materials: CS, 316L, Duplex & Titanium", "QC: 100% Hydrotested & NDE Integrity"],
  ...
  },
  {
    ...
    specs: ["Controlled Hydraulic Tube Expansion", "Eddy Current NDE Tube Wall Inspection", "Rapid Field Seal & Strength Welding"],
  ...
  },
  {
    ...
    description: "High-precision dimensional measurement and metallurgical failure analysis to reconstruct legacy, obsolete OEM heat exchanger designs.",
    specs: ["Precision Dimensional Measurement", "Material Alloy PMI Spectroscopy", "3D CAD Model Export (STEP, DWG)"],
  ...
  },
  {
    ...
    subtitle: "Turbine Guide & Thrust Pads with 100% Bonding",
    category: "Precision Machining",
    description: "White metal babbitt re-lining and precision machining for Turbine Guide pads, Upper guide pads, Lower guide pads, and Thrust Pads with 100% bonding and defect free surface.",
    specs: ["Standards: ASTM B23 Grade 2/3", "UT Bond Test: 100% UT Bond Verified", "Surface Quality: Defect Free Surface"],
    features: ["Turbine Guide pads & Thrust Pads", "Upper guide & Lower guide pads", "100% bonding & defect free surface"],
    asmeCode: "ASTM B23 / ISO 4381",
    applications: "Steam & Hydro Turbines, Generators, Heavy Rotors",
    iconName: "Settings",
  },
  {
    id: "precision-machining",
    title: "CNC Tube Sheet & Flange Machining",
    subtitle: "Heavy Duty CNC Machining Center",
    ...
    specs: ["Custom Tube Sheet Drilling & Grooving", "Precision Flange Serration & Facing", "High Tolerance CNC Baffle Plate Machining"],
    features: ["Triple-grooved tube holes", "Serration flange facing", "Precision CNC deep hole drilling"],
