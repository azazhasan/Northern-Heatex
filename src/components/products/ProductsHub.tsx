    ...
    <div className="space-y-12">
        ...
        <div className="relative z-10 space-y-6 max-w-4xl">
          <div className="flex flex-wrap items-center gap-3">
            <span className="px-3 py-1 rounded-full text-xs font-mono font-bold uppercase tracking-wider bg-cyan-950 text-cyan-400 border border-cyan-500/40 flex items-center gap-1.5">
              <Boxes className="w-3.5 h-3.5" /> {PRODUCTS_DATABASE.length} Core Product Systems
            </span>
            <span className="px-3 py-1 rounded-full text-xs font-mono text-white/70 bg-white/5 border border-white/10">
              ISO 9001:2015 & ISO 14001:2025 Certified • Third Party Inspection (TPI)
            </span>
          </div>

          <h1 className="text-3xl sm:text-5xl font-extrabold text-white tracking-tight leading-tight">
            Products & Engineering Catalogue
          </h1>

          <p className="text-base sm:text-lg text-cyan-200/80 font-medium leading-relaxed">
            Discover Northern HeatEx Corporation's thermal exchange technologies, custom heavy industrial process equipment, and lifecycle engineering services manufactured at Works Facility at Haridwar.
          </p>
        </div>
      </div>
        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="relative flex-1 min-w-[280px]">
            ...
            <input
              ...
              placeholder="Search products by title, metallurgy (e.g. Titanium, CuNi, Stainless), or standards..."
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between font-mono text-xs text-white/50">
          <span>
            Displaying <strong className="text-cyan-400">{filteredProducts.length}</strong> of {PRODUCTS_DATABASE.length} Core Systems
          </span>
